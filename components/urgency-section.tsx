      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-balance text-3xl font-bold tracking-tight text-primary-foreground lg:text-4xl">
            Agenda tu valoración esta semana en Cali
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-primary-foreground/80">
            Recibe diagnóstico digital completo y plan de tratamiento
            personalizado.
          </p>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-6 sm:flex-row">
            <div className="flex items-center gap-3 text-primary-foreground/90">
              ...
              <span className="text-sm font-medium">Citas disponibles</span>
            </div>
            <div className="flex items-center gap-3 text-primary-foreground/90">
              <Stethoscope className="h-5 w-5" />
              <span className="text-sm font-medium">Valoración especializada</span>
            </div>
            <div className="flex items-center gap-3 text-primary-foreground/90">
          ...
          <Button
            asChild
            size="lg"
            className="mt-10 bg-card text-foreground hover:bg-card/90 px-10 text-base font-bold shadow-lg"
          >
