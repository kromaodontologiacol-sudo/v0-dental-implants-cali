    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-8">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <a href="tel:+573235944931" className="flex items-center gap-1.5 text-sm font-medium text-foreground">
      ...
      {isMobileMenuOpen && (
        <div className="border-t border-border bg-card px-4 pb-4 pt-2 lg:hidden">
          ...
          <div className="mt-3 flex flex-col gap-2">
            <a href="tel:+573235944931" className="flex items-center justify-center gap-2 rounded-lg border border-border px-3 py-2.5 text-sm font-medium text-foreground">
              <Phone className="h-4 w-4 text-primary" />
              323 594 4931
            </a>
